...
var mongohandle = 'mongodb://mb:jpkwm@ds123136.mlab.com:23136/sklepsportowy';
mongoose.connect(mongohandle);
...
}).unless({ path: ['/users/authenticate', '/users/register', '/products'] }));
